...
public class BaseClass {
		...
		try {
			if (browsername.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver",
						"C:\\Users\\Deepak\\eclipse-workspace\\Cucumber_Day1\\src\\test\\resource\\com\\cucumber\\driver\\chromedriver.exe");
	...
	public static void sendkey(WebElement element, String value) throws Exception {
		waitforvisibilityofelment(element);
		try {
			if (elementisDisplayed(element) && elementisenabled(element)) {
				element.clear();
	...
	public static void screenshot() throws Exception {
		...
		File saveFile = new File("C:\\Users\\Deepak\\eclipse-workspace\\JunitPractise\\screenshot test1.png");
